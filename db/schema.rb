...
ActiveRecord::Schema.define(:version => 20100813185614) do
  ...
  create_table "dids_user_phones", :force => true do |t|
  ...
  add_index "dids_user_phones", ["did_id"], :name => "did_id"
  add_index "dids_user_phones", ["user_phone_id"], :name => "user_phone_id"
  ...
  add_index "user_phones", ["user_id"], :name => "user_id"
