...
describe Mailer do
  ...
  it "should send the order completed for extend" do
    ...
    mail.body.should == "<html>\n<head>\n  <style>\n    p {\n      font-size: 1em;\n    },\n    .note{\n      font-size: 0.8em;\n    }\n    span.number {\n      font-weight: 'bold';\n    }\n  </style>\n</head>\n<body>\n  <p> Thank You!</p>\n  <p> You have added 30 minutes, for a total talk time of 50 minutes which expires on #{did.expires_at.strftime('%B %d, %Y')}.</p>\n</body>\n</html>"
  end
  ...
  it "should send the order completed for re-up" do
    ...
    order.process({gateway_trans_id: 'blah', raw_status: 'Completed'})
    mail = Mailer.deliver_order_completed(did,order)
    mail.body.should == "<html>\n<head>\n  <style>\n    p {\n      font-size: 1em;\n    },\n    .note{\n      font-size: 0.8em;\n    }\n    span.number {\n      font-weight: 'bold';\n    }\n  </style>\n</head>\n<body>\n  <p> Thank You!</p>\n  <p> Your order has been processed, your Pipes Number (<span=\"number\">443 482 5307</span>)<br>\n    now has a total talk time of 40 minutes which expires on #{did.expires_at.strftime('%B %d, %Y')}\n    </p>\n</body>\n</html>"
  end
